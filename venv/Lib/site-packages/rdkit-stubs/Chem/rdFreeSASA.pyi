...
class SASAOpts(Boost.Python.instance):
    ...
    def __init__(self, alg: SASAAlgorithm, cls: SASAClassifier) -> None:
        """
            C++ signature :
                void __init__(struct _object * __ptr64,enum FreeSASA::SASAOpts::Algorithm,enum FreeSASA::SASAOpts::Classifier)
        """
    @typing.overload
    def __init__(self, alg: SASAAlgorithm, cls: SASAClassifier, pr: float) -> None:
        """
            C++ signature :
                void __init__(struct _object * __ptr64,enum FreeSASA::SASAOpts::Algorithm,enum FreeSASA::SASAOpts::Classifier,double)
        """
    @property
...
def CalcSASA(mol: Mol, radii: typing.Any, confIdx: int = -1, query: Atom = None, opts: SASAOpts = ...) -> float:
    """
        ...
        C++ signature :
            double CalcSASA(class RDKit::ROMol,class boost::python::api::object [,int=-1 [,class RDKit::Atom const * __ptr64=None [,struct FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0x000001EFF9E40970>]]])
    """
def MakeFreeSasaAPolarAtomQuery() -> rdkit.Chem.QueryAtom:
    """
        ...
        C++ signature :
            class RDKit::QueryAtom const * __ptr64 MakeFreeSasaAPolarAtomQuery()
    """
def MakeFreeSasaPolarAtomQuery() -> rdkit.Chem.QueryAtom:
    """
        ...
        C++ signature :
            class RDKit::QueryAtom const * __ptr64 MakeFreeSasaPolarAtomQuery()
    """
def classifyAtoms(mol: Mol, options: SASAOpts = ...) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object classifyAtoms(class RDKit::ROMol {lvalue} [,struct FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0x000001EFF9E40900>])
    """
