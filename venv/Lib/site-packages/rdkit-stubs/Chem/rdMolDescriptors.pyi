...
class AtomPairsParameters(Boost.Python.instance):
    ...
    atomTypes: typing.ClassVar[rdkit.rdBase._vectunsigned int]  # value = <rdkit.rdBase._vectunsigned int object at 0x0000025292A51EC0>
...
class DoubleCubicLatticeVolume(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, isProtein: bool = False, includeLigand: bool = True, probeRadius: float = 1.4, confId: int = -1) -> None:
        """
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKit::ROMol [,bool=False [,bool=True [,double=1.4 [,int=-1]]]])
        """
    @typing.overload
