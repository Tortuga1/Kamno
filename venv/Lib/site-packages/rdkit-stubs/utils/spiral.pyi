...
from numpy import int64 as longlong
...
from numpy import uint32 as ulong
from numpy import uint64 as ulonglong
...
ScalarType: tuple = (int, float, complex, bool, bytes, str, memoryview, numpy.bool, numpy.complex64, numpy.complex128, numpy.clongdouble, numpy.float16, numpy.float32, numpy.float64, numpy.longdouble, numpy.int8, numpy.int16, numpy.intc, numpy.int32, numpy.int64, numpy.datetime64, numpy.timedelta64, numpy.object_, numpy.bytes_, numpy.str_, numpy.uint8, numpy.uint16, numpy.uintc, numpy.uint32, numpy.uint64, numpy.void)
...
sctypeDict: dict = {'bool': numpy.bool, 'float16': numpy.float16, 'float32': numpy.float32, 'float64': numpy.float64, 'longdouble': numpy.longdouble, 'complex64': numpy.complex64, 'complex128': numpy.complex128, 'clongdouble': numpy.clongdouble, 'bytes_': numpy.bytes_, 'str_': numpy.str_, 'void': numpy.void, 'object_': numpy.object_, 'datetime64': numpy.datetime64, 'timedelta64': numpy.timedelta64, 'int8': numpy.int8, 'byte': numpy.int8, 'uint8': numpy.uint8, 'ubyte': numpy.uint8, 'int16': numpy.int16, 'short': numpy.int16, 'uint16': numpy.uint16, 'ushort': numpy.uint16, 'intc': numpy.intc, 'uintc': numpy.uintc, 'int32': numpy.int32, 'long': numpy.int32, 'uint32': numpy.uint32, 'ulong': numpy.uint32, 'int64': numpy.int64, 'longlong': numpy.int64, 'uint64': numpy.uint64, 'ulonglong': numpy.uint64, 'intp': numpy.int64, 'uintp': numpy.uint64, 'double': numpy.float64, 'cdouble': numpy.complex128, 'single': numpy.float32, 'csingle': numpy.complex64, 'half': numpy.float16, 'bool_': numpy.bool, 'int_': numpy.int64, 'uint': numpy.uint64, 'float': numpy.float64, 'complex': numpy.complex128, 'object': numpy.object_, 'bytes': numpy.bytes_, 'a': numpy.bytes_, 'int': numpy.int64, 'str': numpy.str_, 'unicode': numpy.str_}
